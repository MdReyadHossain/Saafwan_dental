...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Our Center</h5>
                <h1 class="display-4">Qualified Dental Professional</h1>
            </div>
            <div class="owl-carousel team-carousel position-relative">
                ...
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-5 w-100 h-100">
                            <img class="img-fluid h-100" src="../Assets/img/team-4.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
