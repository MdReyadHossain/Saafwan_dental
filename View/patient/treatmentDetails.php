            ...
            <div class="container-fluid py-1 px-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Treatment Details</li>
                    </ol>
                    <h6 class="font-weight-bold mb-0">Treatment</h6>
                </nav>
                            ...
                            <div class="table-responsive p-0 " style="height: 50vh; overflow-y: scroll;">
                                <table class=" table align-items-center justify-content-center mb-0">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th class="text-start text-secondary text-xs font-weight-semibold opacity-7">Appointment Date</th>
                                            <th class="text-center text-secondary text-xs font-weight-semibold opacity-7 ps-2">Treatment Performed</th>
                                            <th class="text-end text-secondary text-xs font-weight-semibold opacity-7 ps-2">Dental Surgeon</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
