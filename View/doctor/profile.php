                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="529, Solmaid, Dhaka, Bangladesh">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="d-flex justify-content-center mt-4">
                                        <div class="d-grid text-center">
                                            <span class="text-lg font-weight-bolder">56</span>
                                            <span class="text-sm opacity-8">Patient</span>
                                        </div>
                                        <div class="d-grid text-center mx-4">
                                            <span class="text-lg font-weight-bolder">42</span>
                                            <span class="text-sm opacity-8">Male</span>
                                        </div>
                                        <div class="d-grid text-center">
                                            <span class="text-lg font-weight-bolder">14</span>
