...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($isValid) {
        $msg = "A new user has sent an email from Saafwan.com<br>You can contact thorugh this Email<br><br>Email: " . $email . "<br><br><a href='https://saafwan.com/'>Saafwan Dental and Ortho Dontics</a>";
